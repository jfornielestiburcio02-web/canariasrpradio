    ...
    return (
      <div className="min-h-screen flex items-center justify-center p-6 bg-slate-50">
        <Card className="w-full max-w-md border-none shadow-2xl bg-white text-center p-10">
          ...
          <h2 className="text-xl font-bold text-slate-900">Error de Persistencia</h2>
          <p className="text-sm text-slate-500 mt-2">El navegador no ha guardado tu sesión. Intenta borrar las cookies de este sitio y vuelve a entrar.</p>
          <Button asChild className="mt-6 w-full bg-primary">
            <Link href="/">Reintentar Login</Link>
          </Button>
        </Card>
      </div>
    );
