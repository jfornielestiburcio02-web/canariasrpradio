    ...
    <div className="min-h-screen bg-background flex flex-col md:flex-row">
      ...
      <aside className="w-full md:w-64 bg-primary text-primary-foreground p-6 flex flex-col gap-8 shadow-xl">
        ...
        <nav className="flex flex-col gap-2 flex-1">
          <Link href="/tablonera" className="flex items-center gap-3 p-3 rounded-lg bg-white/10 text-accent hover:bg-white/20 transition-all font-medium">
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <Card className="bg-white border-primary/5 shadow-sm">
              ...
              <CardContent className="space-y-4">
                {[
                  { title: "Desembarco en el Puerto de Santa María", time: "Hace 2 horas", type: "success" },
                  { title: "Comercio de especias completado", time: "Hace 5 horas", type: "info" },
                  { title: "Nuevo mensaje de la Capitanía", time: "Hace 1 día", type: "alert" }
                ].map((item, i) => (
